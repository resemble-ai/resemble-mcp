...
<script
  ...
  data-porter-key="pk_live_..."
  data-porter-endpoint="https://app.resemble.ai/api/v2/porter/telemetry"
></script>
```
...
Porter.onVerdict(({ verdict, kind, sessionId }) => {
...
| --- | --- | --- | --- |
| `GET` | `/porter/sessions` | API key | [List visits](/detect/agent-detection/sessions) |
| `GET` | `/porter/sessions/{id}` | API key | [Get a visit](/detect/agent-detection/sessions#get-a-session) and the evidence behind its verdict |
| `GET` | `/porter/analytics` | API key | [Get totals](/detect/agent-detection/sessions#get-analytics) for your traffic |
| `GET` | `/porter/sites` | API key | [List integrations](/detect/agent-detection/integrations) |
| `POST` | `/porter/sites` | API key | [Create an integration](/detect/agent-detection/integrations) |
| `PATCH` | `/porter/sites/{id}` | API key | [Update an integration](/detect/agent-detection/integrations) |
| `POST` | `/porter/sites/{id}/rotate_key` | API key | [Rotate a publishable key](/detect/agent-detection/integrations) |
